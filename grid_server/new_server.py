    ...
    def handle_client(self, client_socket):
        ...
        try:
            while True:
                ...
                if req['type'] == 'change_password':
                    player = self.client_player.get(client_socket)
                    player.password = req['data']['password']
                    player.save()

                if req['type'] == 'enter_game':
                    player = self.client_player.get(client_socket)
